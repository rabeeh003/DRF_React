        ...
        <nav    className="bg-white border-gray-200 dark:bg-gray-900">
            <div    className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <Link to="/"    className="flex items-center space-x-3 rtl:space-x-reverse">
                    <img src="https://icon2.cleanpng.com/20231212/cyk/transparent-microsoft-laptop-12-inch-laptop-red-and-pink-scree-microsoft-laptop-with-red-pink-screen-apple-store6578416c5f2bc3.5029693417023798843898.jpg"    className="h-8" alt="Logo" />
                    <span    className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Crack store</span>
                </Link>
                <div    className={`relative ${isSearchOpen ? 'block' : 'hidden'} hidden sm:block`}>
                ...
                <div    className={`items-center justify-between w-full md:flex md:w-auto md:order-1 ${isSearchOpen ? 'hidden' : 'block'}`} id="navbar-search">
                    <ul    className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        {authToken ? (
                            ...
                            <li>
                                <span onClick={removeToken}    className="block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500" aria-current="page">Logout</span>
                            </li>
                            </>
                        ) : (
                            <>
